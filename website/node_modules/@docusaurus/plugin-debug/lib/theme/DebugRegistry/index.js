...
function DebugRegistry() {
    return (react_1.default.createElement(DebugLayout_1.default, null,
        ...
        react_1.default.createElement("ul", { className: "clean-list" }, Object.values(registry_1.default).map(([, aliasedPath, resolved]) => (react_1.default.createElement("li", { key: aliasedPath, className: styles_module_css_1.default.listItem },
