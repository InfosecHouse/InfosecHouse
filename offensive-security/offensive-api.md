...
| :--- | :--- | :--- |
| [API Security Checklist](https://github.com/shieldfy/API-Security-Checklist) | Checklist of the most important security countermeasures when designing, testing, and releasing your API . | [![last-commit](https://badgen.net/github/last-commit/shieldfy/API-Security-Checklist)](https://badgen.net/github/last-commit/shieldfy/API-Security-Checklist) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
...
| Tool | Description | Directory |
| :--- | :--- | :--- |
| [MindAPI](https://github.com/dsopas/MindAPI) | Organize your API security assessment by using MindAPI. | [![last-commit](https://badgen.net/github/last-commit/dsopas/MindAPI)](https://badgen.net/github/last-commit/dsopas/MindAPI) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |

## Manipulation & Testing

| Tool | Description | Directory |
| :--- | :--- | :--- |
| [Arjun](https://github.com/s0md3v/Arjun) | HTTP parameter discovery suite. | [![last-commit](https://badgen.net/github/last-commit/s0md3v/Arjun)](https://badgen.net/github/last-commit/s0md3v/Arjun) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
| [Astra](https://github.com/flipkart-incubator/Astra) | Automated Security Testing For REST API's | [![last-commit](https://badgen.net/github/last-commit/flipkart-incubator/Astra)](https://badgen.net/github/last-commit/flipkart-incubator/Astra) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
...
| [Hoppscotch](https://github.com/hoppscotch/hoppscotch) | Open source tool that covers the entire testing spectrum \(functional, security, load, mocking\). | [![last-commit](https://badgen.net/github/last-commit/hoppscotch/hoppscotch)](https://badgen.net/github/last-commit/hoppscotch/hoppscotch) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
...
| [Karate](https://github.com/intuit/karate) | Test automation made simple. | [![last-commit](https://badgen.net/github/last-commit/intuit/karate)](https://badgen.net/github/last-commit/intuit/karate) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
...
| Tool | Description | Directory |
| :--- | :--- | :--- |
| [crAPI](https://github.com/OWASP/crAPI) | Completely ridiculous API \(crAPI\). | [![last-commit](https://badgen.net/github/last-commit/OWASP/crAPI)](https://badgen.net/github/last-commit/OWASP/crAPI) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
| [Damn Vulnerable GraphQL App](https://github.com/dolevf/Damn-Vulnerable-GraphQL-Application) | An intentionally vulnerable implementation of Facebook's GraphQL technology, to learn and practice GraphQL Security. | [![last-commit](https://badgen.net/github/last-commit/dolevf/Damn-Vulnerable-GraphQL-Application)](https://badgen.net/github/last-commit/dolevf/Damn-Vulnerable-GraphQL-Application) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
| [DVMS](https://github.com/ne0z/DamnVulnerableMicroServices) | This is vulnerable microservice written in many language to demonstrating OWASP API Top Security Risk. | [![last-commit](https://badgen.net/github/last-commit/Cne0z/DamnVulnerableMicroServices)](https://badgen.net/github/last-commit/ne0z/DamnVulnerableMicroServices) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
| [dvws-node](https://github.com/snoopysecurity/dvws-node) | Damn Vulnerable Web Service is a vulnerable web service/API/application that can be used to learn webservices/API vulnerabilities. | [![last-commit](https://badgen.net/github/last-commit/snoopysecurity/dvws-node)](https://badgen.net/github/last-commit/snoopysecurity/dvws-node) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
...
| [VAmPI](https://github.com/erev0s/VAmPI) | Vulnerable REST API with OWASP top 10 vulnerabilities for APIs. | [![last-commit](https://badgen.net/github/last-commit/erev0s/VAmPI)](https://badgen.net/github/last-commit/erev0s/VAmPI) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
| [vAPI](https://github.com/roottusk/vapi) | Vulnerable Adversely Programmed Interface which is Self-Hostable PHP Interface that mimics OWASP API Top 10 scenarios in the means of Exercises. | [![last-commit](https://badgen.net/github/last-commit/roottusk/vapi)](https://badgen.net/github/last-commit/roottusk/vapi) ![opensource](https://raw.githubusercontent.com/InfosecHouse/InfosecHouse/main/icons/opensource.png) |
