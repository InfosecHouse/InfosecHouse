...
function DebugRoutes() {
    return (react_1.default.createElement(DebugLayout_1.default, null,
        ...
        react_1.default.createElement("ul", { className: "clean-list" }, routes_1.default.map(({ path, exact, routes: childRoutes }) => (react_1.default.createElement("li", { key: path, className: styles_module_css_1.default.listItem },
