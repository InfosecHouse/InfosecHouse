...
function DebugMetadata() {
    ...
    return (react_1.default.createElement(DebugLayout_1.default, null,
        ...
        react_1.default.createElement("ul", { className: "clean-list" }, Object.entries(siteMetadata.pluginVersions).map(([name, versionInformation]) => (react_1.default.createElement("li", { key: name, className: styles_module_css_1.default.listItem },
